...
def prepare_text_simple(title, abstract):
    """Combine title and abstract into single text"""
...
class RetrievalConfig:
    """Configuration for all retrieval models"""
